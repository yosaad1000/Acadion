-- Run this SQL in your Supabase SQL console to fix authentication errors
-- Copy and paste this entire script into the SQL editor and execute
...
-- Verify the setup
SELECT 'Setup complete! RLS policies and functions updated.' as status;